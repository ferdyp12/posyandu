...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?= route_to('Imunisasi::create'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Buat <?= $title; ?></a>
</div>
                            ...
                            foreach ($imunisasi as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-id="<?= $row->id_imunisasi; ?>" class="btn-sm btn-danger delete-imunisasi" href="" data-toggle="tooltip" title="Delete"><i class="fas fa-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                            <?php $nomor++;
                            endforeach; ?>
...
<script>
    ...
    $('.delete-imunisasi').on('click', function(event) {
        event.preventDefault();
        event.stopImmediatePropagation();

        var id_imunisasi = $(this).data('id')
