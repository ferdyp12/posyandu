                        ...
                        <tbody>
                            ...
                            foreach ($jp as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= $row->nama; ?></td>
                                    <td>
                                        <a class="btn-sm btn-warning" href="<?= route_to('JabatanPetugas::edit', $row->id_petugas_jabatan); ?>" data-toggle="tooltip" title="Update"><i class="fas fa-pen" title="Update"></i></a>
                                        <a data-id="<?= $row->id_petugas_jabatan; ?>" class="btn-sm btn-danger delete-jp" href="" data-toggle="tooltip" title="Delete"><i class="fas fa-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                            <?php $nomor++;
                            endforeach; ?>
...
<script>
    ...
    $('.delete-jp').on('click', function(event) {
        ...
        var id_petugas_jabatan = $(this).data('id')
            ...
            preConfirm: () => {
                return $.ajax({
                    ...
                    data: {
                        [csrfToken]: csrfHash,
                        _method: 'DELETE',
                        id_petugas_jabatan: id_petugas_jabatan
                    },
