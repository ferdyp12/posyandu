...
<script>
    ...
    $('#form-create-ayah .form-input').on('keyup', function() {
        $.ajax({
            method: 'POST',
            ...
            success: function(data) {
                if ($('#nama').val() == '' || $('#kk').val() == '' || $('#nik').val() == '' || $('#no_telp').val() == '' || $('#alamat').val() == '' || $('#rt').val() == '' || $('#rw').val() == '') {
    ...
    $('#form-create-ayah').on('submit', function(event) {
